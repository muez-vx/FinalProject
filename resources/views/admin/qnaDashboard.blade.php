            ...
            <!-- Modal -->
            <div class="modal fade" id="addQnaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <button type="submitt" class="btn btn-primary">Add Q&A</button>
                    </div>
                    </form>
                </div>
                </div>
            ...
            <!-- Edit Q&A Modal -->
            <div class="modal fade" id="editQnaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submitt" class="btn btn-primary">Update Q&A</button>
                    </div>
                    </form>
                </div>
                </div>
            ...
            <!-- Show Answer Modal -->
            <div class="modal fade" id="showAnsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
            ...
            <div class="modal fade" id="importQnaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                      <button type="submitt" class="btn btn-info">Import Q&A</button>
                    </div>
                </form>
                  </div>
                </div>
    ...
    <script>
            ...
            $("#addQna").submit(function(e){
             ...
             if($(".answers").length < 2)
             {
                $(".error").text("Please add atleast 2 answers");
                setTimeout(function(){
                    $(".error").text(""); 
               },2000);
             }
           ...
           $("#editQna").submit(function(e){
             ...
             {
                $(".editError").text("Please add atleast 2 answers");
                setTimeout(function(){
                    $(".editError").text(""); 
               },2000);
             }
